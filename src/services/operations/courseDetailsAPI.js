...
export const fetchCourseDetails = async (courseId) => {
  ...
  let result = null;
  try {
    // Updated to use GET with dynamic courseId parameter
...
export const showAllCategories = fetchCourseCategories;
...
export const editCourseDetails = async (data, token) => {
  ...
  const toastId = toast.loading("Loading...");
  try {
    // Updated to use PUT with dynamic courseId parameter
    const courseId = data.get ? data.get("courseId") : data.courseId;
    const response = await apiConnector(
      "PUT",
...
export const updateSection = async (data, token) => {
  ...
  const toastId = toast.loading("Loading...");
  try {
    // Updated to use PUT with dynamic sectionId parameter
...
export const updateSubSection = async (data, token) => {
  ...
  const toastId = toast.loading("Loading...");
  try {
    // Updated to use PUT with dynamic subsectionId parameter
    const { subsectionId, ...updateData } = data;
    const response = await apiConnector(
      "PUT",
...
export const deleteCourse = async (data, token) => {
  const toastId = toast.loading("Loading...");
  try {
    // Updated to use DELETE with dynamic courseId parameter
    const { courseId } = data;
    const response = await apiConnector(
      "DELETE",
...
export const fetchFeaturedCourses = async () => {
  ...
  try {
    const response = await apiConnector(
      "GET",
      courseEndpoints.GET_FEATURED_COURSES_API
    );
    if (!response?.data?.success) {
