 ...
 */}
      <Link to={`/courses/${course._id}`} className="block w-full">
        <div className="hover:scale-[1.02] transition-all duration-200 w-full max-w-none sm:max-w-[335px] bg-richblack-800 rounded-xl overflow-hidden shadow-lg">
          ...
          <div className="flex flex-col gap-2 px-4 py-4">
            <p className="text-lg font-semibold text-richblack-5 line-clamp-2">{course?.courseName}</p>{/* COURSE NAME*/}
